/* =========================================
   المكون: روضة المحبين (البوابة الرئيسية - النسخة الآمنة)
...
(function() {
    ...
    const RawdatHub = () => {
        ...
        const ProphetSeerahComp = window.ProphetSeerah || (() => <div className="p-4 text-center">جاري تحميل السيرة...</div>);
        const AsmaHusnaComp = window.AsmaHusna || (() => <div className="p-4 text-center">جاري تحميل الأسماء...</div>);
